...
<!-- SkinFT Section -->
    ...
    <div class="w-full pt-32 lg:pt-52 pb-32 bg-title text-center"> 
        <div class="container mx-auto">
            <h2 class="hidden text-center text-light mb-6 lg:mb-16 text-lg lg:block"><span>S</span>kin<span>FT #322</span></h2>
            <div class="w-full flex flex-col justify-center lg:flex-row font-bold">
                <div class="flex flex-row w-full justify-around lg:w-1/3 lg:justify-center">
                    ...
                    <form action="" type="GET" class="flex flex-row rounded-xl border-4 border-light h-11 text-lg lg:text-2xl outline-none">
                        <input type="text" name="nft" id="nft_num" value="322" class="px-4 h-9 w-24 font-light text-light bg-transparent text-center focus-visible:outline-none" autofocus>
                ...
                <div class="w-full mb-11 lg:order-3 lg:w-1/3">
                    <h2 class="lg:hidden text-center text-light mb-6 lg:mb-16 text-lg lg:block"><span>S</span>kin<span>FT #322</span></h2>
